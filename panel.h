...
class Panel {
  public:
    ...
    void
      ...
      setRowColor(uint8_t x, uint8_t r, uint8_t g, uint8_t b),
      setRowColor(uint8_t x, uint32_t c),
      setColumnColor(uint16_t y, uint8_t r, uint8_t g, uint8_t b),
      setColumnColor(uint16_t y, uint32_t c),
